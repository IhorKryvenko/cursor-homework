...
function getMyTaxes(salary) {
    console.log(Number(this.tax * salary))
}
...
function getMiddleTaxes(country) {
    console.log(Number(this.tax * this.middleSalary))
}
...
function getMySalary(country) {
    ...
    let getObj = () => {
        ...
        objMySalary.taxes = Number((this.tax * objMySalary.salary).toFixed(2));
        objMySalary.profit = Number((objMySalary.salary - objMySalary.taxes).toFixed(2))
